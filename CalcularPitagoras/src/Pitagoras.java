...
public class Pitagoras extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("A Hipotenusa é igual a: ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int hipotenusa,cateto1, cateto2;
                        cateto1 = Integer.parseInt(jTextField1.getText());
                        cateto2 = Integer.parseInt(jTextField2.getText());
                        hipotenusa = (cateto1 * cateto1) + (cateto2 * cateto2);
                        jLabel3.setVisible(true);
                        jLabel3.setText("A Hipotenusa é igual a:  " + Math.sqrt(hipotenusa));
